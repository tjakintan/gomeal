...
import { limitLength } from "@/utils/text";
      ...
      >
        ...
        <View className="w-full">
          ...
          <Input
            ...
            onChangeText={(value) =>
              updateInfo("dish_description", limitLength(value, 250))
            }
            multiline
          />
          <Text
            ...
            style={{
              marginTop: 4,
              textAlign: "right",
              color: (250 - info.dish_description?.length) <= 20 ? colors.danger : colors.secondaryText,
            }}
          >
            {(250 - info.dish_description?.length)} characters left
          </Text>
        </View>
